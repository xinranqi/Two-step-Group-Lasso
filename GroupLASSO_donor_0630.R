...
agvhd2 <- read_sas("C:/Users/xinqi/Desktop/d.sas7bdat",NULL)
agvhd3 <- read_sas("C:/Users/xinqi/Desktop/d.sas7bdat",NULL)
anc500 <- read_sas("C:/Users/xinqi/Desktop/d.sas7bdat",NULL)
cgvhd <- read_sas("C:/Users/xinqi/Desktop/d.sas7bdat",NULL)
dead <- read_sas("C:/Users/xinqi/Desktop/d.sas7bdat",NULL)
lfs <- read_sas("C:/Users/xinqi/Desktop/d.sas7bdat",NULL)
plate20 <- read_sas("C:/Users/xinqi/Desktop/d.sas7bdat",NULL)
relapse <- read_sas("C:/Users/xinqi/Desktop/d.sas7bdat",NULL)
trm <- read_sas("C:/Users/xinqi/Desktop/d.sas7bdat",NULL)
...
paired = (irgs_indx[which(irgs_indx$data_pair %in% c("Donly","paired")),-c(1,2)])[, seq(from=(185*5 + 1), to=(185*7), by=1)]
pairedcov = irgs_covD[which(irgs_covD$data_pair %in% c("Donly","paired")),-1]
pairedFullInfo = aims_irgs_jan2018[which(aims_irgs_jan2018$data_pair %in% c("Donly","paired")),]
  ...
  if(SubGroupLASSO==TRUE && (length(Active.Index) > (sum(GROUP <= sum(1-PENALTY)) + 6))) {
    ...
    if (length(MinorIndx.Active) > 0) {
      ...
      if (dim(CombinedMinorIRG)[2] == 1) {
        ...
        colnames(CombinedMinorIRG) = paste0("irg_dc",completePatient)
      } else {
        colnames(CombinedMinorIRG) = paste0("irg_dc",completePatient)
      }
...
group2 = c(rep(1, times=5), rep(2, times=4), rep(3, times=2), rep(4, times=4),
           ...
           rep(9, times=6), rep(10, times=4), rep(11, times=7),
           rep(seq(from=(11+1), to=(11+185), by=1), times=2) )
penaltyfactor2 = c(rep(0, times=11), rep(1, times=185))
...
group9 = c(rep(1, times=5), rep(2, times=4), rep(3, times=6), rep(4, times=4),
           ...
           rep(12, times=7),
           rep(seq(from=(12+1), to=(12+185), by=1), times=2) )
penaltyfactor9 = c(rep(0, times=12), rep(1, times=185))
